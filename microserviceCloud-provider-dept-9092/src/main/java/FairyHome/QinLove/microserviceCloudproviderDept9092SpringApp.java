...
public class microserviceCloudproviderDept9092SpringApp {
    public static void main(String[] args){
        ConfigurableApplicationContext run = SpringApplication.run(microserviceCloudproviderDept9092SpringApp.class, args);
        int beanDefinitionCount = run.getBeanDefinitionCount();
        System.out.println("microserviceCloudprovideDept9090微服务一共初始化了"+beanDefinitionCount +"个实例化类");
